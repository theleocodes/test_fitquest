  ...
  return (
    ...
    >
        ...
        >
            ...
            <a href="#yoga" style={{textDecoration: 'none', color: '#3A1212', borderBottom: '3px solid #FF2625'}}>Yoga</a>
            <a href="#healthtips" style={{textDecoration: 'none', color: '#3A1212', borderBottom: '3px solid #FF2625'}}>HealthTips</a>
        </Stack>
    </Stack>
